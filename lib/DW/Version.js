...
DW.Version.prototype.constructor = DW.Version;

DW.Version.prototype.getCommitHash = function(callback) {
  var fs = require('fs');
...
DW.Version.prototype.getVersionHash = function(callback) {
...
DW.Version.prototype.updateHashesFile = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  var scope = this;
