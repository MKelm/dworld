...
DW.Creature.prototype.loadMovementTargetPosition = function() {
  ...
  if (this.movement.stop === false &&
    ...
    // we use the initial start position always to get a limited movement area
    var tX = this.startPosition.x + Math.round(xD), tY = this.startPosition.y + Math.round(yD);
