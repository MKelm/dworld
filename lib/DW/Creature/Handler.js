...
DW.CreatureHandler.prototype.addCreature = function(type, fieldX, fieldY) {
  ...
  if (typeof this.creatures[fieldY] == "undefined") this.creatures[fieldY] = [];
...
DW.CreatureHandler.prototype.removeCreature = function(creature, keepSprite) {
  if (typeof this.creatures[creature.position.y] != "undefined" &&
      typeof this.creatures[creature.position.y][creature.position.x] != "undefined" &&
...
DW.CreatureHandler.prototype.getCreaturesByPosition = function(fieldX, fieldY) {
  if (typeof this.creatures[fieldY] == "object" &&
      typeof this.creatures[fieldY][fieldX] == "object" &&
...
DW.CreatureHandler.prototype.updatePosition = function(oldPosX, oldPosY, index, newPosX, newPosY) {
  if (typeof this.creatures[oldPosY] != "undefined" && typeof this.creatures[oldPosY][oldPosX] != "undefined" &&
    ...
    if (typeof this.creatures[newPosY] == "undefined") this.creatures[newPosY] = [];
...
DW.CreatureHandler.prototype.update = function() {
  for (var fY in this.creatures) {
    for (var fX in this.creatures[fY]) {
