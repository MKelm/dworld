...
DW.Game = function() {
  ...
  this.addEventListener('window-fight-attack-click', dw.util.getEventListener(this, "handleEvent"));
  this.addEventListener('window-fight-spell-click', dw.util.getEventListener(this, "handleEvent"));
...
DW.Game.prototype.start = function() {
  this.display.drawBorderContents();
...
DW.Game.prototype.handleEvent = function(scope, event) {
  switch (event.type) {
    ...
    case "window-close-click":
      ...
      break;
    case "window-fight-spell-click":
      var isSpell = true;
    case "window-fight-attack-click":
      if (scope.windows.fight.currentCreature !== null) {
        // attack / hit points calculation
        var playerDamage = scope.player.makeStrike(isSpell === true);
        ...
        scope.display.drawBorderContents();
