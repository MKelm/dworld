...
DW.Player = function() {
  this.position = { x: 4, y: 4 }; // start field position
  this.speed = 100;
  this.hitPoints = 50;
  this.attackPoints = 2; // todo: more complex attack points calculation
  this.dexterity = 0.5; // todo: add dexterity calculation later

  this.inventory = new DW.PlayerInventory();
...
DW.Player.prototype.makeHit = function() {
...
DW.Player.prototype.setHit = function(attackPoints) {
