...
DW.Display.prototype.reset = function() {
  // reset display, e.g. for transition
  for (var i = 0; i < this.mapContainer.children.length; i++) {
    this.mapContainer.removeChild(this.mapContainer.children[i]);
  }
  for (var i = 0; i < this.creaturesContainer.children.length; i++) {
    this.creaturesContainer.removeChild(this.creaturesContainer.children[i]);
  }
}
