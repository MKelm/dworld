...
DW.Display.prototype.drawBorderContents = function() {
  ...
  this.borderGfx.beginFill(0xD90800);
  this.borderGfx.drawRect(-1 * 5.5 * 50, posY + (height - healthHeight), 50, height);
  this.borderGfx.endFill();

  // mana bar content
  var manaHeight = 1 / this.game.player.maxMana * this.game.player.mana * height;
  this.borderGfx.beginFill(0x0400D9);
  this.borderGfx.drawRect(4.5 * 50, posY + (height - manaHeight), 50, height);
  this.borderGfx.endFill();
  ...
  // health bar border
  this.borderGfx.drawRect(-1 * 5.5 * 50, posY, 50, height);
  // mana bar boder
  this.borderGfx.drawRect(4.5 * 50, posY, 50, height);
}
