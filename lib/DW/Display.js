...
DW.Display.prototype.drawBorderContents = function() {
  ...
  // health bar content
  var height = 1 / this.game.player.maxHealth * this.game.player.health * 9 * 50;
  this.borderGfx.beginFill(0xD90800);
  this.borderGfx.drawRect(-1 * 5.5 * 50, (-1 * 4.5 * 50) + (9 * 50 - height), 50, height);
  this.borderGfx.endFill();

  // mana bar content
  height = 1 / this.game.player.maxMana * this.game.player.mana * 9 * 50;
  this.borderGfx.beginFill(0x0400D9);
  this.borderGfx.drawRect(4.5 * 50, (-1 * 4.5 * 50) + (9 * 50 - height), 50, height);
  this.borderGfx.endFill();

  // map border
  this.borderGfx.lineStyle(3, 0xFFFFFF);
  this.borderGfx.drawRect(-1 * 4.5 * 50, -1 * 4.5 * 50, 9 * 50, 9 * 50);
  // health bar border
  this.borderGfx.drawRect(-1 * 5.5 * 50, -1 * 4.5 * 50, 50, 9 * 50);
  // mana bar boder
  this.borderGfx.drawRect(4.5 * 50, -1 * 4.5 * 50, 50, 9 * 50);
}
