...
DW.Display.prototype.drawMapAreas = function() {
  ...
  var textures = [
        PIXI.Texture.fromImage("data/gfx/field_grass.png"),
        PIXI.Texture.fromImage("data/gfx/field_dirt.png"),
        PIXI.Texture.fromImage("data/gfx/field_rock.png"),
        PIXI.Texture.fromImage("data/gfx/field_tree.png")
      ];
