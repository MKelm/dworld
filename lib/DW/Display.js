...
DW.Display.prototype.drawBorderContents = function() {
  ...
  this.borderGfx.drawRect(4 * 50, posY + (height - manaHeight), 25, manaHeight);
  this.borderGfx.endFill();
  ...
  // mana bar boder
  this.borderGfx.drawRect(4 * 50, posY, 25, height);
  ...
  if (this.borderManaText === null) {
    ...
    this.borderManaText.position = { x: 4 * 50 + 2, y: posY + height - 10 };
